...
public class Task {
    ...
    public static void main(String[] args) throws IOException {
        ...
        WriteTextTo(FILE_NAME);
    }

    private static void WriteTextTo(String file_name) throws IOException {
    ...
    static void writeInt(OutputStream out, int num) throws IOException {
        ByteBuffer doubleBuffer = ByteBuffer.allocate(4);
        doubleBuffer.order(bOrder).putInt(num);
        out.write(doubleBuffer.array());
    }
